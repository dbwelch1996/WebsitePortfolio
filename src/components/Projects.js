      ...
      <Container>
        <Row>
          <Col className="mb-5">
            ...
            <p>
              These are some of the projects I have worked on. For more projects I've worked on or to see the code, check out my GitHub!
            </p>
      ...
      DNS Resolver
              ...
              <Tab.Content>
                <Tab.Pane eventKey="first">
                  <Row>
                    <Col md={6}>
                      <img src={projects[0].imgURL} alt={projects[0].title} className="img-fluid" />
                    </Col>
                    <Col md={6}>
                ...
                <Tab.Pane eventKey="second">
                  <Row>
                    <Col md={6}>
                      <img src={projects[1].imgURL} alt={projects[1].title} className="img-fluid" />
                    </Col>
                    <Col md={6}>
                ...
                <Tab.Pane eventKey="third">
                  <Row>
                    <Col md={6}>
                      <img src={projects[2].imgURL} alt={projects[2].title} className="img-fluid" />
                    </Col>
                    <Col md={6}>
